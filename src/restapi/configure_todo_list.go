...
import (
	...
	"HarshCoding/todo-GOswagger-service/src/database"
	"HarshCoding/todo-GOswagger-service/src/middlewares"
	"HarshCoding/todo-GOswagger-service/src/models"
	"HarshCoding/todo-GOswagger-service/src/restapi/operations"
	"HarshCoding/todo-GOswagger-service/src/restapi/operations/todos"
)
...
func setupGlobalMiddleware(handler http.Handler) http.Handler {
	return installSwaggerJSONHandler(middlewares.InstallUImiddleware(handler))
}
